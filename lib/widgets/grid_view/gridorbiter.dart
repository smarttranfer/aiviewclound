...
import 'package:aiviewcloud/widgets/grid_view/drag.dart';
...
typedef bool AcceptCallback(int data);
...
class _MainGridViewState extends State<MainGridView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        Container(
          margin: EdgeInsets.only(top: _isDragStart ? 80.h : 0),
        ...
        _isDragStart
            ? DragTarget(
                    ...
                    Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text("Kéo vào đây để loại bỏ camera",
                ...
                onWillAccept: (data) {
                  print(data);
                  // setState(() {
                  //   isDeleted = int.parse(data as String);
                  // });
                  return true;
                },
                onAccept: (data) {
                  widget.onAccept(int.parse(data as String));
                },
              )
            : Container(),
        !_isDragStart
