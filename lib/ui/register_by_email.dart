...
//       _showErrorMessage("Không để trống thông tin");
//       return;
//     }
...
//                   Pin(start: 0.0, end: 0.0),
//                   child:
//                       // Adobe XD layer: 'Đăng ký tài khoản b…' (shape)
//                       Container(
...
//                   child: Stack(
//                     children: <Widget>[
//                       HeaderWidget(headerText: "Đăng ký tài khoản"),
//                       Pinned.fromPins(
...
//                         Pin(size: 16.0, middle: 0.6491),
//                         child:
//                             // Adobe XD layer: 'Trung bình' (text)
//                             SingleChildScrollView(
//                                 child: Text(
//                           'Trung bình',
//                           style: TextStyle(
