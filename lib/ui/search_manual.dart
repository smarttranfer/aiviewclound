...
class Tmkimthcng extends StatelessWidget {
  Tmkimthcng({
    Key? key,
  }) : super(key: key);
  @override
            ...
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  Pin(start: 0.0, end: 0.0),
                  child:
                      // Adobe XD layer: 'Tìm kiếm thủ công (…' (shape)
                      Container(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        ...
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromPins(
                              Pin(size: 137.0, start: 17.0),
                              Pin(size: 21.0, middle: 0.7322),
                              child:
                                  // Adobe XD layer: '8000' (text)
                                  Text(
                                '8000',
                                style: TextStyle(
                                  fontFamily: 'SFProDisplay-Regular',
                      ...
                      Pinned.fromPins(
                        ...
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromPins(
                              Pin(size: 17.1, end: 16.2),
                              Pin(size: 12.0, middle: 0.7055),
                              child:
                        ...
                        child:
                          ...
                          children: <Widget>[
                            ...
                            Pinned.fromPins(
                              ...
                              Pin(size: 20.0, start: 0.0),
                              child:
                                  // Adobe XD layer: 'Địa chỉ IP *' (text)
                                  Text.rich(
                                TextSpan(
                                  style: TextStyle(
                                    fontFamily: 'SFProDisplay-Regular',
                            ...
                            Pinned.fromPins(
                              Pin(size: 137.0, start: 16.0),
                              Pin(size: 20.0, middle: 0.7374),
                              child:
                                  // Adobe XD layer: 'Nhập địa chỉ IP' (text)
                                  Text(
                                'Nhập  địa chỉ IP',
                                style: TextStyle(
                                  fontFamily: 'SFProDisplay-Regular',
                      ...
                      Pinned.fromPins(
                        ...
                        Pin(size: 16.0, middle: 0.4573),
                        child:
                            // Adobe XD layer: 'Mật khẩu là mã xác …' (text)
                            Text(
                          'Mật khẩu là mã xác thực hoặc mã kích hoạt',
                          style: TextStyle(
                            fontFamily: 'SFProDisplay-Regular',
                            fontSize: 14,
                            color: const Color(0xff818181),
...
const String _svg_im14cd =
    '<svg viewBox="-4727.0 -1382.0 10.0 20.0" ><path transform="translate(-4727.0, -1382.0)" d="M 10 0 L 0 10 L 10 20" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="butt" stroke-linejoin="bevel" /></svg>';
