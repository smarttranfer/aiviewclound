...
class Hngdncitthitb extends StatelessWidget {
  Hngdncitthitb({
    Key? key,
  }) : super(key: key);
  @override
            ...
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  Pin(start: 0.0, end: 0.0),
                  child:
                      // Adobe XD layer: 'Hướng dẫn cài đặt t…' (shape)
                      Container(
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Pinned.fromPins(
                        ...
                        child:
                            // Adobe XD layer: 'Hướng dẫn cài đặt t…' (text)
                            Text(
                          AppLocalizations.of(context)
                              .translate('setup_instruction'),
                          style: TextStyle(
                      ...
                      Pinned.fromPins(
                        ...
                        child:
                            // Adobe XD layer: 'Bấm và giữ nút RESE…' (text)
                            Text.rich(
                          TextSpan(
                            style: TextStyle(
                              fontFamily: 'SFProDisplay-Regular',
...
const String _svg_dcru1b =
    '<svg viewBox="2808.0 561.0 10.0 20.0" ><path transform="translate(2808.0, 561.0)" d="M 10 0 L 0 10 L 10 20" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="butt" stroke-linejoin="bevel" /></svg>';
