...
class Qrcodeplugin extends StatefulWidget {
  const Qrcodeplugin({
    required Key key,
...
class _QRViewState extends State<Qrcodeplugin> {
  ...
  void _onPlatformViewCreated(int id) {
    _channel = MethodChannel('vn.solidtech/qrview_$id');
